package com.crawl.crawler.responsebody;

import java.util.Date;
import java.util.List;

import com.crawl.crawler.mixingmodel.dien_giaANDbai_bao;
import com.crawl.crawler.model.bai_bao;
import com.crawl.crawler.model.dien_gia;

import jakarta.persistence.Lob;

public class DetailConferenceBody {
	int id;
	private String name;
	...
	public List<dien_giaANDbai_bao> dien_gia_x_bai_bao;
	public int getId() {
		return id;
	}
